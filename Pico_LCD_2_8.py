...
class LCD_2inch8(framebuf.FrameBuffer):
    ...
    def __init__(self):
        ...
        self._bl_pwm.duty_u16(0)  # BACKLIGHT OFF immediately
        ...
        self.show_up()
        self.bl_ctrl(100)  # BACKLIGHT ON only after a clean frame is shown
    ...
    # duty: 0..100
        if duty <= 0:
            ...
            self._bl_pwm.duty_u16(65535)
        else:
            self._bl_pwm.duty_u16(int(65535 * duty / 100))
